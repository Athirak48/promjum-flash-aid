...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-bold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_4px_0_0_hsl(270,80%,50%)] hover:shadow-[0_2px_0_0_hsl(270,80%,50%)] hover:translate-y-[2px] active:shadow-none active:translate-y-[4px]",
        ...
        hero: "bg-primary text-primary-foreground shadow-[0_6px_0_0_hsl(270,80%,50%)] hover:shadow-[0_3px_0_0_hsl(270,80%,50%)] hover:translate-y-[3px] active:shadow-none active:translate-y-[6px] text-lg px-8 py-4",
      },
      size: {
