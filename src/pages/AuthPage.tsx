            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="register" className="mt-0 focus-visible:outline-none">
                ...
                <form onSubmit={handleSignUp} className="space-y-3">
                  ...
                  <div className="flex items-start gap-2 p-3 rounded-lg bg-red-500/10 border border-red-500/20 backdrop-blur-sm">
                    <span className="text-red-400 text-lg leading-none mt-0.5">✱</span>
                    <p className="text-xs text-red-200/90 leading-relaxed">
                      สมัครสมาชิกแล้วเช็คในอีเมลเพื่อกดยืนยันตัวตน
                    </p>
                  </div>
                </form>
              </TabsContent>
