...
export default function AuthPage() {
  ...
  const { signInWithGoogle, user, getUserRole } = useAuth();
        ...
        <Card className="glass-card border-white/20 rounded-[2rem]">
          <CardHeader className="text-center pb-4 pt-6">
            <div className="flex flex-col items-center justify-center gap-3 mb-4">
              <div className="p-3 bg-white/95 rounded-xl shadow-[0_0_20px_rgba(168,85,247,0.3)] backdrop-blur-md border border-white/50">
                <img
                  src={promjumLogo}
                  alt="Promjum Logo"
          ...
          <CardContent className="pt-2 pb-8">
            <Button
              type="button"
              variant="outline"
              className="w-full h-14 text-base rounded-xl border-white/20 bg-white/5 hover:bg-white/10 text-white hover:text-white flex items-center justify-center gap-3 backdrop-blur-sm transition-all hover:scale-[1.02] active:scale-[0.98]"
