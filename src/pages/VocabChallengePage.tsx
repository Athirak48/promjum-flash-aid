...
import {
    Zap, Clock, Trophy, Share2, Crown, Flag,
    Lightbulb, ChevronRight, Play, X, BookOpen,
    Download, Folder, Check, Loader2, ArrowLeft
} from 'lucide-react';
...
export default function VocabChallengePage() {
    ...
    useEffect(() => {
        trackPageView('Vocab Challenge', 'vocab_challenge');
    }, [trackPageView]);


    // State
    const [timeLeft, setTimeLeft] = useState<TimeLeft>({ days: 12, hours: 4, minutes: 30, seconds: 0 });
    const [myStats, setMyStats] = useState<MyStats>({ rank: 428, bestTime: "01:45.00", nextRank: 400 });
    ...
    const onStartGame = (isWarmup: boolean) => {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden flex flex-col">
            ...
            <div
                ...
                style={{
                    backgroundImage: `linear-gradient(to bottom, rgba(0,20,10,0.8), rgba(0,0,0,0.9)), url('https://images.unsplash.com/photo-1448375240586-882707db888b?w=1920')`,
                    filter: 'brightness(0.5) saturate(0.7)'
                }}
            />

            {/* Fog/Mist Overlay */}
            <div className="absolute inset-0 bg-gradient-to-t from-emerald-950/50 via-transparent to-slate-900/70 pointer-events-none fixed" />

            {/* Header / Back Button */}
            <div className="relative z-20 px-4 py-4 md:px-8 md:py-6 flex items-center justify-between">
                <Button
                    variant="ghost"
            ...
            {/* Main Content Area */}
            <div className="relative z-10 flex-1 overflow-y-auto px-4 pb-8 md:px-8">
                <div className="max-w-7xl mx-auto">

                    {/* Copied from IndividualChallengeView.tsx */}
                        ...
                        <div className="lg:col-span-8 space-y-6">
                            ...
                            >
                                <div className="flex flex-col lg:flex-row justify-between items-start gap-4 lg:gap-0 relative z-10">
                                    ...
                                    <div className="flex flex-col gap-3 mt-auto self-stretch lg:self-end w-full lg:min-w-[240px] lg:max-w-[280px]">
                                        ...
                                        <button
                                            onClick={() => {
                                                trackButtonClick('Start Run', 'vocab_challenge');
                                                onStartGame(false);
                                            }}
                            ...
                            >
                                ...
                                <div className="divide-y divide-slate-50">
                                    ...
                                    {/* Row 2 - EmmaW */}
                                    <div className="grid grid-cols-12 gap-4 px-8 py-4 items-center hover:bg-slate-50/50 transition-colors hidden lg:grid">
                                    ...
                                    <div className="grid grid-cols-12 gap-4 px-8 py-4 items-center bg-purple-50/50 border-l-4 border-purple-500">
                                        ...
                                        <div className="col-span-5">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div className="font-bold text-slate-800 text-sm">{user ? user.email?.split('@')[0] : 'Guest'}</div>
            ...
            {/* Dev Dialog - Identical to GameLobby */}
